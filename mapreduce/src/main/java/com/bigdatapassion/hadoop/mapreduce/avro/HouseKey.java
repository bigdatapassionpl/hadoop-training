...
public class HouseKey extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"HouseKey\",\"namespace\":\"com.bigdatapassion.hadoop.mapreduce.avro\",\"fields\":[{\"name\":\"type\",\"type\":\"string\"},{\"name\":\"hood\",\"type\":\"string\"}]}");
  ...
  public static com.bigdatapassion.hadoop.mapreduce.avro.HouseKey.Builder newBuilder() {
    return new com.bigdatapassion.hadoop.mapreduce.avro.HouseKey.Builder();
  }
  
  /** Creates a new HouseKey RecordBuilder by copying an existing Builder */
  public static com.bigdatapassion.hadoop.mapreduce.avro.HouseKey.Builder newBuilder(com.bigdatapassion.hadoop.mapreduce.avro.HouseKey.Builder other) {
    return new com.bigdatapassion.hadoop.mapreduce.avro.HouseKey.Builder(other);
  }
  
  /** Creates a new HouseKey RecordBuilder by copying an existing HouseKey instance */
  public static com.bigdatapassion.hadoop.mapreduce.avro.HouseKey.Builder newBuilder(com.bigdatapassion.hadoop.mapreduce.avro.HouseKey other) {
    return new com.bigdatapassion.hadoop.mapreduce.avro.HouseKey.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<HouseKey>
    ...
    private Builder() {
      super(com.bigdatapassion.hadoop.mapreduce.avro.HouseKey.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.bigdatapassion.hadoop.mapreduce.avro.HouseKey.Builder other) {
      super(other);
    ...
    private Builder(com.bigdatapassion.hadoop.mapreduce.avro.HouseKey other) {
            super(com.bigdatapassion.hadoop.mapreduce.avro.HouseKey.SCHEMA$);
      if (isValidValue(fields()[0], other.type)) {
        this.type = data().deepCopy(fields()[0].schema(), other.type);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'type' field */
    public com.bigdatapassion.hadoop.mapreduce.avro.HouseKey.Builder setType(java.lang.CharSequence value) {
    ...
    public com.bigdatapassion.hadoop.mapreduce.avro.HouseKey.Builder clearType() {
      type = null;
    ...
    /** Sets the value of the 'hood' field */
    public com.bigdatapassion.hadoop.mapreduce.avro.HouseKey.Builder setHood(java.lang.CharSequence value) {
    ...
    public com.bigdatapassion.hadoop.mapreduce.avro.HouseKey.Builder clearHood() {
      hood = null;
